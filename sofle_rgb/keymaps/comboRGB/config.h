...
// keypeek/audio_visualizer disable-own-raw_hid_receive_kb handshake now
// lives in key_colors/config.h + audio_visualizer/config.h (qmk-modules) —
// no manual KEYPEEK_DISABLE_RAW_HID_HANDLER needed here anymore.
